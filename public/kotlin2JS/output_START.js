if (typeof kotlin === 'undefined') {
  throw new Error("Error loading module 'Kotlin2jsOutput_START'. Its dependency 'kotlin' was not found. Please, check whether 'kotlin' is loaded prior to 'Kotlin2jsOutput_START'.");
}
var Kotlin2jsOutput_START = function (_, Kotlin) {
  'use strict';
  ...
  function StartScripts() {
    StartScripts$Companion_getInstance();
  }
  function StartScripts$Companion() {
    StartScripts$Companion_instance = this;
    this.testScript_0 = StartScripts$Companion$testScript$lambda;
    this.all = [this.testScript_0];
  }
  function StartScripts$Companion$testScript$lambda() {
    return Unit;
  }
  StartScripts$Companion.$metadata$ = {
    kind: Kind_OBJECT,
    simpleName: 'Companion',
    interfaces: []
  };
  var StartScripts$Companion_instance = null;
  function StartScripts$Companion_getInstance() {
    if (StartScripts$Companion_instance === null) {
      new StartScripts$Companion();
    }
    return StartScripts$Companion_instance;
  }
  StartScripts.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'StartScripts',
    interfaces: []
  };
  function main(args) {
    var tmp$, tmp$_0;
    tmp$ = StartScripts$Companion_getInstance().all;
  ...
  Object.defineProperty(StartScripts, 'Companion', {
    get: StartScripts$Companion_getInstance
  });
  _.StartScripts = StartScripts;
  _.main_kand9s$ = main;
  main([]);
  Kotlin.defineModule('Kotlin2jsOutput_START', _);
  return _;
}(typeof Kotlin2jsOutput_START === 'undefined' ? {} : Kotlin2jsOutput_START, kotlin);
